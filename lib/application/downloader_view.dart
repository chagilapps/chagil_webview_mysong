...
class DownloaderView extends StatefulWidget with WidgetsBindingObserver {
  final TargetPlatform? platform;

  DownloaderView({Key? key, this.title, this.platform}) : super(key: key);

  final String? title ;

  @override
  _DownloaderViewState createState() => _DownloaderViewState();
}
